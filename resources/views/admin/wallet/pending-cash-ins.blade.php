                ...
                <tbody>
                    @forelse($pendingCashIns as $cashIn)
                        <tr>
                            ...
                            <td>
                                @if($cashIn->hasPaymentProof())
                                    <button onclick="showPaymentProofModal('{{ $cashIn->getPaymentProofUrl() }}', '{{ $cashIn->payment_proof_description }}')" class="btn btn-primary" style="font-size:12px;padding:4px 8px;">
